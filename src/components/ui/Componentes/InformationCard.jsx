...
export default function InformationCard({ title, details, onEdit, onChangeAccountType }) {
    return (
...
InformationCard.propTypes = {
    ...
    details: PropTypes.arrayOf(
        PropTypes.shape({
            ...
            options: PropTypes.arrayOf(PropTypes.string), // Opcional, solo si el campo tiene opciones de selección
        })
    ).isRequired,
    onEdit: PropTypes.func.isRequired,
    onChangeAccountType: PropTypes.func, // Función para manejar el cambio de tipo de cuenta
};

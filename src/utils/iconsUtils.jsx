...
export const getIconForCategory = (categoriaNombre, className = "inline-block") => {
  switch (categoriaNombre) {
    ...
    case "Café":
      return <Coffee size={18} className={`${className} mr-2`} />;
    case "Entretenimiento":
      return <Music size={18} className={`${className} mr-2`} />;
    case "Belleza":
      return <Scissors size={18} className={`${className} mr-2`} />;
    case "Vacaciones":
      return <Sun size={18} className={`${className} mr-2`} />;
    case "Restaurantes":
      return <Utensils size={18} className={`${className} mr-2`} />;
    ...
    case "Emprendimiento":
      return <Briefcase size={18} className={`${className} mr-2`} />;
    case "Proyecto":
      return <Lightbulb size={18} className={`${className} mr-2`} />;
    case "Seguridad":
      return <Shield size={18} className={`${className} mr-2`} />;
    case "Caridad":
      return <Heart size={18} className={`${className} mr-2`} />;
    case "Logro":
      return <Flag size={18} className={`${className} mr-2`} />;
    case "Medio Ambiente":
      return <Trees size={18} className={`${className} mr-2`} />;
    case "Estrella":
      return <Star size={18} className={`${className} mr-2`} />;

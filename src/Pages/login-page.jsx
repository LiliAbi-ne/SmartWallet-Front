...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-amber-100 to-amber-200">
      <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto my-8 shadow-2xl rounded-xl overflow-hidden">
        ...
        >
          ...
          >
            ¿No tienes una cuenta? <a href="/register" className="font-medium text-amber-600 hover:underline">Registrarse</a>
          </motion.div>
          <motion.div 
          ...
          >
            <a href="#" className="text-sm text-amber-600 hover:underline">¿Olvidaste tu contraseña?</a>
          </motion.div>
        </motion.div>
      </div>
    </div>
